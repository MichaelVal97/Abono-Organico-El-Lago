...
let AuthService = class AuthService {
    ...
    jwtService;
    constructor(userRepository, preferencesRepository, jwtService) {
    ...
    async login(loginDto) {
        ...
        if (!user.password) {
            throw new common_1.UnauthorizedException('Esta cuenta usa Google Sign-In. Por favor inicia sesión con Google.');
        }
